...
suptitle = 'Multi Model Mean' + ' zonal mean salinity (ave. from '+str(ystr)+' to '+str(yend)+')'
outfile = './fig/ZMS_diff_bias.png'
...
outstatsfile=path_out + 'ZMS_omip1-omip2_stats.nc'
...
bounds = [-0.2, -0.15, -0.1, -0.07, -0.04, -0.02, 0.02, 0.04, 0.07, 0.1, 0.15, 0.2 ]
cmap = 'RdBu_r'
item = 'omip2-1'
ticks_bounds = bounds
