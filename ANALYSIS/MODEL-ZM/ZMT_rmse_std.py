...
suptitle = 'Multi Model Mean OMIP-' + str(mip) + ' zonal mean temperature (ave. from '+str(ystr)+' to '+str(yend)+')'
outfile = './fig/ZMT_bias_std_OMIP-'+str(mip)+'.png'
...
outstatsfile = path_out + 'ZMT_omip-'+str(omip+1)+'-STDs.nc'
...
bounds = [0.1, 0.2, 0.4, 0.7, 1.0, 1.5, 2.0]
cmap = 'YlOrBr'
ticks_bounds = bounds
...
#fig.text(0.25,0.925,'OMIP-'+str(mip),fontsize=12,
