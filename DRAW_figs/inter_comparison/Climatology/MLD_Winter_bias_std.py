...
bounds2 = [-1000, -500, -300, -200, -100, -50, -20, 20, 50, 100, 200, 300, 500, 1000]
ticks_bounds2 = [-1000, -500, -300, -200, -100, -50, -20, 20, 50, 100, 200, 300, 500, 1000]
bounds3 = [10, 20, 30, 50, 100, 200, 300, 500, 1000]
ticks_bounds3 =  [10, 20, 30, 50, 100, 200, 300, 500, 1000]
bounds4 =       [-200, -100, -50, -30, -20, -10, -5, 5, 10, 20, 30, 50, 100, 200]
ticks_bounds4 = [-200, -100, -50, -30, -20, -10, -5, 5, 10, 20, 30, 50, 100, 200]
#bounds4 = np.arange(-200,220,10)
#ticks_bounds4 = np.arange(-200,220,50)
...
for panel in range(6):
    if (item[panel] == 'omip1bias'):
        ...
        bounds = bounds3
        ticks_bounds = bounds3
        dadraw = DS['omip2mean'].std(dim='model',skipna=True)
