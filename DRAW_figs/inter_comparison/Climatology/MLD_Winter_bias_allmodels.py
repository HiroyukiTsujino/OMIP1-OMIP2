...
mskfile = '../analysis/MLD/MLD_deBoyer_Montegut/mld_DR003_winmask.nc'
# Obs
...
bounds1 = np.array([0,20,50,100,150,200,300,400,500,600,1000,1500,2000,4000])
ticks_bounds1 = np.array([0,20,50,100,150,200,300,400,500,600,1000,1500,2000,4000])
#bounds1 = [-1000, -500, -300, -200, -100, -50, -20, 20, 50, 100, 200, 300, 500, 1000]
#ticks_bounds1 = [-1000, -500, -300, -200, -100, -50, -20, 20, 50, 100, 200, 300, 500, 1000]
#bounds1 = np.arange(-200,220,20)
#ticks_bounds1 = np.arange(-200,220,40)
bounds2 =       [-200, -100, -50, -30, -20, -10, -5, 5, 10, 20, 30, 50, 100, 200]
ticks_bounds2 = [-200, -100, -50, -30, -20, -10, -5, 5, 10, 20, 30, 50, 100, 200]
#bounds2 = np.arange(-100,110,10)
#ticks_bounds2 = np.arange(-100,110,20)

cmap = [ 'RdYlBu_r', 'RdYlBu_r', 'bwr', 'RdYlBu_r' ]

item = [ 'omip1bias', 'omip2bias', 'omip2-1', 'deBoyer' ]

outfile = './fig/MLD_Winter_bias_allmodels_'+item[nv_out]+'.png'
...
if (item[nv_out] == 'omip1bias' or item[nv_out] == 'omip2bias'):
    ...
    #title_append = ' rmse = ' + '{:.1f}'.format(rmse) + ' $\mathrm{m}$'
...
summary_t=summary.T
print (summary_t)
summary_t.to_csv('csv/MLD_winter_OMIP' + str(omip_out) + '.csv')
