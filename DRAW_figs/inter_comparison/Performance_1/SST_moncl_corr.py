...
if (sys.argv[1] == 'MMM'):
    suptitle = 'Multi Model Mean' + ' (Correlation of monthly climatology of SST from 1980 to 2009)'
    outfile = './fig/toscor_monclim_MMM'
else:
    suptitle = sys.argv[1] + ' (Correlation of monthly climatology of SST from 1980 to 2009)'
    model_list[0] = [sys.argv[1]]
    model_list[1] = [sys.argv[1]]
    outfile = './fig/toscor_monclim_' + sys.argv[1]
