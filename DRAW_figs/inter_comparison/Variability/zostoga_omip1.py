...
title_name='Global mean thermosteric sea level OMIP1 (CORE) relative to the 2005-2009 mean'
...
zostoga_df_all.plot(y=zostoga_df_all.columns[i],color='darkred',linewidth=4,ax=axes,ylim=[-0.04,0.04],xlim=[1948,2018])
