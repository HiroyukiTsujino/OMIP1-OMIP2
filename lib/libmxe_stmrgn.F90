...
module libmxe_stmrgn
  ...
  public :: libmxe_stmrgn__xn
  interface libmxe_stmrgn__xn
    module procedure libmxe_stmrgn__xn_2d_int
    module procedure libmxe_stmrgn__xn_3d_int
    module procedure libmxe_stmrgn__xn_2d_dble
    module procedure libmxe_stmrgn__xn_3d_dble
  end interface libmxe_stmrgn__xn
  ...
  private :: libmxe_stmrgn__x_2d_int
  private :: libmxe_stmrgn__x_3d_int
  private :: libmxe_stmrgn__n_2d_int
  private :: libmxe_stmrgn__n_3d_int
...
subroutine libmxe_stmrgn__xn_3d_dble( buf, iuvts, ireverse, para )
  implicit none

  type(type_libmxe_para),intent(in) :: para
  integer(4),intent(in)             :: iuvts, ireverse
  real(8),intent(inout)             :: buf(:,:,:)

  integer(4) :: kdim

  kdim = size( buf, 3 )
  call libmxe_stmrgn__var3_x( buf, kdim, iuvts, para )
  call libmxe_stmrgn__var3_n( buf, kdim, iuvts, ireverse, para )

end subroutine libmxe_stmrgn__xn_3d_dble
!-----------------------------------------------------------------


subroutine libmxe_stmrgn__xn_2d_dble( buf, iuvts, ireverse, para )
  implicit none
  ...
  call libmxe_stmrgn__var2_x( buf, iuvts, para )
  call libmxe_stmrgn__var2_n( buf, iuvts, ireverse, para )

end subroutine libmxe_stmrgn__xn_2d_dble
!-----------------------------------------------------------------


subroutine libmxe_stmrgn__xn_3d_int( buf, iuvts, ireverse, para )
  implicit none
  ...
  do k = 1, size( buf, 3 )
    call libmxe_stmrgn__x_2d_int( buf(:,:,k), iuvts, para )
    call libmxe_stmrgn__n_2d_int( buf(:,:,k), iuvts, ireverse, para )
  enddo

end subroutine libmxe_stmrgn__xn_3d_int
!-----------------------------------------------------------------


subroutine libmxe_stmrgn__xn_2d_int( buf, iuvts, ireverse, para )
  implicit none
  ...
  call libmxe_stmrgn__x_2d_int( buf, iuvts, para )
  call libmxe_stmrgn__n_2d_int( buf, iuvts, ireverse, para )

end subroutine libmxe_stmrgn__xn_2d_int
!-----------------------------------------------------------------


subroutine libmxe_stmrgn__x_3d_int( buf, iuvts, para )
  implicit none
...
end subroutine libmxe_stmrgn__x_3d_int
!-----------------------------------------------------------------


subroutine libmxe_stmrgn__x_2d_int( buf, iuvts, para )
  implicit none
  ...
  if ( .not. para%ldef )  then
    write(*,*) 'Error at libmxe_stmrgn__x'
...
end subroutine libmxe_stmrgn__x_2d_int
!-----------------------------------------------------------------
...
subroutine libmxe_stmrgn__n_2d_int( buf, iuvts, ireverse, para )
  implicit none
...
end subroutine libmxe_stmrgn__n_2d_int
!-----------------------------------------------------------------


subroutine libmxe_stmrgn__n_3d_int( buf, iuvts, ireverse, para )
  type(type_libmxe_para), intent(in) :: para
  integer(4), intent(inout) :: buf(:,:,:)
  integer(4), intent(in) :: iuvts
  integer(4), intent(in) :: ireverse
...
end subroutine libmxe_stmrgn__n_3d_int
