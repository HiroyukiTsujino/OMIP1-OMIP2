...
!============================================================
  ...
  subroutine io_interface__register( io_var, para, grid, &
    ...
    character(3) :: shape_world
    
    integer(4),parameter :: ndims_max = 4
...
!============================================================
  ...
  subroutine io_interface__grads_read_3d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_read_3d'
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_read_3d: empty file_base'
      stop
    endif
...
!------------------------------------------------------------
  ...
  subroutine io_interface__grads_read_2d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_read_2d'
      write(*,*) '  io is not registered.'
      stop
    endif
    if ( nrec > io%nm )  then
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_read_2d: empty file_base'
      stop
    endif
...
!------------------------------------------------------------
  ...
  subroutine io_interface__grads_read_1d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_read_1d'
      write(*,*) '  io is not registered.'
      stop
    endif
    if ( nrec > io%nm )  then
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_read_1d: empty file_base'
      stop
    endif
...
!------------------------------------------------------------
  ...
  subroutine io_interface__grads_read_0d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_read_0d'
      write(*,*) '  io is not registered.'
      stop
    endif
    if ( nrec > io%nm )  then
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_read_0d: empty file_base'
      stop
    endif
...
!============================================================
  ...
  subroutine io_interface__grads_write_3d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_write_3d'
      write(*,*) '  io is not registered.'
      stop
    endif
    if ( nrec > io%nm )  then
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_write_3d: empty file_base'
      stop
    endif
...
!------------------------------------------------------------
  ...
  subroutine io_interface__grads_write_2d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_write_2d'
      write(*,*) '  io is not registered.'
      stop
    endif
    if ( nrec > io%nm )  then
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_write_2d: empty file_base'
      stop
    endif
...
!------------------------------------------------------------
  ...
  subroutine io_interface__grads_write_1d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_write_1d'
      write(*,*) '  io is not registered.'
      stop
    endif
    if ( nrec > io%nm )  then
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_write_1d: empty file_base'
      stop
    endif
...
!------------------------------------------------------------
  ...
  subroutine io_interface__grads_write_0d( para, io, io_var, nrec, r, nvar )
    ...
    !-- check --
    if ( .not. io%ldef )  then
      write(*,*) 'Error at io_interface__grads_write_0d'
      write(*,*) '  io is not registered.'
      stop
    endif
    if ( nrec > io%nm )  then
    ...
    if ( len(io_var%file_base) == 0 )  then
      write(*,*) 'Error at io_interface__grads_write_0d: empty file_base'
      stop
    endif
